...
// Macro to <span class="ez48b507" id="ez48b507_10">find number</span> of elements in <span class="ez48b507" id="ez48b507_4">array</span>
...
// A <a data-text="driver" id="cr_it_item_0" class="cr_it_item tooltipstered">driver</a> program to <span class="ez48b507" id="ez48b507_3">test</span> above functions
int main(void)
{
    struct node *head = NULL;
    head = createList();
